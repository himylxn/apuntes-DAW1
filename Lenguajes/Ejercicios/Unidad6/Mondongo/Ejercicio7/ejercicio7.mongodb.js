...
use('dylan');
db.pokemons.find({'name.english':'Squirtle'})
...
use('dylan');
db.pokemons.update({'name.english':'Squirtle'},{$set:{description:"Squirtle's shell is not merely used for protection"}})
...
use('dylan');
db.pokemons.find({'base.Attack':{$lte:20}},{'name.english':1, _id:0})

//Show a list with the english name of all Pokemons with attack 50 or greater and type Poison.
use('dylan');
db.pokemons.find({$and:[{'base.Attack':{$gt:50}},{type:'Poison'}]},{'name.english':1,_id:0})

//Show a list with the english name and type of all Pokemons with name Pikachu or with attack 20 or lower.
use('dylan');
db.pokemons.find({$or:[{'name.english':'Pikachu'},{'base.Attack':{$lte:20}}]},{'name.english':1, _id:0})
...
use('dylan');
db.pokemons.updateMany({'name.english':{$in:['Pikachu','Squirtle','Bulbasaur','Charmander']}},{$push:{attacks:{$each:['strong attack','ultra attack']}}});

//Add 10 to the value of attack of all pokemon whose name begins with characters: Pik.
use('dylan');
db.pokemons.update({'name.english':{$regex:/^Pik.*$/}},{$inc:{'base.Attack':10}})

//Search english name of Pokemons of type Bug.
use('dylan');
db.pokemons.find({type:'Bug'},{'name.english':1,_id:0})

//Search the french name of Pokemons that are not of type Bug.
use('dylan');
db.pokemons.find({type:{$ne:'Bug'}},{'name.french':1,_id:0})

//Search english and french name of Pokemons that are not of electric type. 
use('dylan');
db.pokemons.find({type:{$ne:'Electric'}},{'name.french':1,'name.english':1,_id:0})


//Search english and french name of Pokemons whose defense is not lower than 49.
use('dylan');
db.pokemons.find({'base.Defense':{$ne:{$lt:49}}},{'name.english':1,'name.french':1, _id:0})
...
use('dylan');
db.pokemons.count({'base.Defense':{$gt:70}})

//Delete all pokemons of type fire.
use('dylan');
db.pokemons.deleteMany({type:'Fire'})

//Delete one pokemon of your election.
use('dylan');
db.pokemons.deleteOne({'name.english':'Pikachu'})